...
const Card = styled.div` background: white; width: 100%; max-width: 440px; padding: 40px 25px; border-radius: 28px; box-shadow: 0 15px 45px rgba(0, 0, 0, 0.07); text-align: center; border: 1px solid #eee; `;
...
const ActionGroup = styled.div` display: flex; align-items: center; justify-content: center; gap: 10px; margin-top: 20px; `;
const TextActionButton = styled.button` background: none; border: none; color: #adb5bd; font-size: 0.9rem; text-decoration: underline; cursor: pointer; transition: 0.2s; &:hover { color: #228be6; } `;
const Divider = styled.span` color: #e9ecef; font-size: 0.8rem; `;
