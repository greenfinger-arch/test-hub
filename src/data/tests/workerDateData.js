export const workerDateData = {
  ...
  results: {
    FOOD: {
      ...
      affiliateLink: "https://example.com/restaurants"
    },
    MOOD: {
      name: "인생샷 제조, 비주얼 나이트",
      ...
      affiliateLink: "/https://example.com/rooftop"
    },
    REST: {
      name: "고요한 쉼표, 힐링 나이트",
      ...
      affiliateLink: "/https://example.com/cozy-place"
    },
    PLAY: {
      name: "텐션 업! 액티비티 나이트",
      ...
      affiliateLink: "/https://example.com/activity"
    }
  }
};