export const fengShuiWealthData = {
  ...
  isReady: true,
  mainImg: "https://images.unsplash.com/photo-1616489953149-8b449108154e?w=800",
  questions: [
    {
  ...
  results: {
    FLOW: {
      ...
      img: "https://images.unsplash.com/photo-1513519247388-193ad513d746?w=600",
      ...
      affiliateLink: "https://search.shopping.naver.com/search/all?query=해바라기액자"
    },
    CHAOS: {
      name: "돈이 새어 나가는 '에너지 블랙홀'",
      img: "https://images.unsplash.com/photo-1505691938895-1758d7eaa511?w=600",
      ...
      affiliateLink: "https://search.shopping.naver.com/search/all?query=데스크테리어+정리함"
    },
    REFLECT: {
      name: "운을 밀어내는 '반사된 기회'",
      img: "https://images.unsplash.com/photo-1558997519-83ea9252edf8?w=600",
      ...
      affiliateLink: "https://search.shopping.naver.com/search/all?query=풍수지리+발매트"
    },
    STAGNANT: {
      ...
      affiliateLink: "https://search.shopping.naver.com/search/all?query=인테리어+단스탠드"
    }
  }
};